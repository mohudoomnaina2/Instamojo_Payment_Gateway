...
<html lang="en">
	...
	<div class="page-header">
		...
		<form action="pay.php" method="POST" accept-charset="utf-8">
			...
			<div class="form-group">
			<label>Purpose</label>
			<input type="text" class="form-control" name="purpose" value="Mobile Back Case" readonly> 
			</div>
			<div class="form-group">
			<label>Amount</label>
			<input type="email" class="form-control" name="amount" Value="100" readonly>
			</div>
			<p><input type="submit" name="pay" class="btn btn-success btn-lg" value="Click here to Pay"></p>
		</form>
